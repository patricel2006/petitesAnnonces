...
$(document).ready(function () {
    ...
    let content = document.querySelector('#navbarSupportedContent'),
    ...
    btn.addEventListener('click', function () {
        console.log('click');
        overlay.parentNode.classList.add(activatedClass);
    ...
    overlay.addEventListener('click', function () {
        console.log('click');
        overlay.parentNode.classList.remove(activatedClass);
